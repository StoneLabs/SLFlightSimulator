...
/// <summary>
/// AeroPropeller. Works in tandem with AeroEngine to simulate engine/propeller combo
/// </summary>
public class AeroPropeller : MonoBehaviour
{
    ...
    /// <summary>
    /// Torque generated by propeller's air resistance
    /// </summary>
    ...
    {
        // Visualize blade length and forces. (4 blades are visualizes regardless of blades variable) 
#if UNITY_EDITOR
